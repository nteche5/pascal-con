                ...
                <div className={styles.contactDetails}>
                  <div className={styles.contactItem}>
                    ...
                    <div>
                      <h3>Address</h3>
                      <p>
                        PKSA Construction & Engineering Consultancy Ltd<br />
                        Ghana, Africa
                      </p>
                    </div>
                  </div>
                  ...
                  <div className={styles.contactItem}>
                    ...
                    <div>
                      <h3>Phone</h3>
                      <p>
                        <a href="tel:+233555810550">+233 555 810 550</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className={styles.contactItem}>
                    ...
                    <div>
                      <h3>Email</h3>
                      <p>
                        <a href="mailto:pascalconstructionlmt@gmail.com">pascalconstructionlmt@gmail.com</a>
                      </p>
                    </div>
                  </div>
                </div>
